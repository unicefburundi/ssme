...
class Migration(migrations.Migration):
    ...
    dependencies = [("ssme_activities", "0002_auto_20151104_0951")]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                verbose_name=b"district", to="ssme_activities.District"
            ),
        ),
        migrations.AlterField(
            model_name="cds",
        ...
        migrations.AlterField(
            ...
            name="province",
            field=models.ForeignKey(
                verbose_name=b"province", to="ssme_activities.Province"
            ),
        ),
        migrations.AlterField(
